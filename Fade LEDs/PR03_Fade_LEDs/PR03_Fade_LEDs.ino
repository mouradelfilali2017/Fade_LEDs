...

{
  ...
  analogWrite(led0, 4);    // posar PWM del pin 3 a  4 
  analogWrite(led1, 0);    // posar PWM del pin 5 a  0
  analogWrite(led2, 0);    // posar PWM del pin 6 a  0
  analogWrite(led3, 0);    // posar PWM del pin 9 a  0
  analogWrite(led4, 0);    // posar PWM del pin 10 a 0
  ...
  analogWrite(led0, 12);    // posar PWM del pin 3 a 12
  analogWrite(led1, 4);    // posar PWM del pin 5 a  4
  analogWrite(led2, 0);    // posar PWM del pin 6 a  0
  analogWrite(led3, 0);    // posar PWM del pin 9 a  0
  analogWrite(led4, 0);    // posar PWM del pin 10 a 0
  analogWrite(led5, 0);    // posar PWM del pin 11 a 0
  ...
  analogWrite(led0, 27);    // posar PWM del pin 3 a 27
  analogWrite(led1, 12);    // posar PWM del pin 5 a 12
  analogWrite(led2, 4);    // posar PWM del pin 6 a  4
  analogWrite(led3, 0);    // posar PWM del pin 9 a  0
  analogWrite(led4, 0);    // posar PWM del pin 10 a 0
  analogWrite(led5, 0);    // posar PWM del pin 11 a 0
  ...
  analogWrite(led0, 62);    // posar PWM del pin 3 a 62
  analogWrite(led1, 27);    // posar PWM del pin 5 a 27
  analogWrite(led2, 12);    // posar PWM del pin 6 a 12
  analogWrite(led3, 4);    // posar PWM del pin 9 a 4
  analogWrite(led4, 0);    // posar PWM del pin 10 a 0
  analogWrite(led5, 0);    // posar PWM del pin 11 a 0
  ...
  analogWrite(led0, 255);    // posar PWM del pin 3 a 255
  analogWrite(led1, 62);    // posar PWM del pin 5 a 62
  analogWrite(led2, 27);    // posar PWM del pin 6 a 27
  analogWrite(led3, 12);    // posar PWM del pin 9 a 12
  analogWrite(led4, 4);    // posar PWM del pin 10 a 4
  analogWrite(led5, 0);    // posar PWM del pin 11 a 0
  ...
  analogWrite(led0, 255);    // posar PWM del pin 3 a 255
  analogWrite(led1, 255);    // posar PWM del pin 5 a 255
  analogWrite(led2, 62);    // posar PWM del pin 6 a 62
  analogWrite(led3, 27);    // posar PWM del pin 9 a 27
  analogWrite(led4, 12);    // posar PWM del pin 10 a 12
  analogWrite(led5, 4);    // posar PWM del pin 11 a 4
  ...
  analogWrite(led1, 255);    // posar PWM del pin 5 a 255
  analogWrite(led2, 255);    // posar PWM del pin 6 a 255
  analogWrite(led3, 62);    // posar PWM del pin 9 a  62
  analogWrite(led4, 27);    // posar PWM del pin 10 a 27
  analogWrite(led5, 12);    // posar PWM del pin 11 a 12
  ...
  analogWrite(led4, 62);    // posar PWM del pin 10 a 62 
  analogWrite(led5, 27);    // posar PWM del pin 11 a 27
  ...
  analogWrite(led2, 255);    // posar PWM del pin 6 a 255
  analogWrite(led3, 255);    // posar PWM del pin 9 a 255
  analogWrite(led4, 225);    // posar PWM del pin 10 a 255
  analogWrite(led5, 62);    // posar PWM del pin 11 a 62
  ...
  analogWrite(led3, 255);    // posar PWM del pin 9 a 255
  analogWrite(led4, 225);    // posar PWM del pin 10 a 255
  analogWrite(led5, 225);    // posar PWM del pin 11 a 255
